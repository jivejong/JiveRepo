...
Enforces a fixed turn limit per session. Opens with an efficiency tip. Closes with an auto-summary. Forces intentional use and clean endings.
...
Strips any decision down to 2–3 real decision points and forces a Yay or Nay verdict. MAYBE only fires when a specific missing data point would genuinely change the outcome.
...
Anchors the session to a stated mission. Detects drift. Parks tangents without losing them. Routes you back.
...
Reads your writing sample first, your background second. Preserves regional spelling, generational register, and professional vocabulary. Strips AI tells. Your voice goes in; your voice comes out.
...
Useful for ESL writers who want to sound like a human, not a style guide. Calibrated by first-language background. Rewrites to plain conversational English without erasing cultural voice.
...
Won't solve the problem for you. Will point you toward your skills, your network, and your own judgment. Encourages independence. Discourages isolation. Delivers all of this in the register of someone who grew up without a help desk and turned out fine. Gnarly, dude!
