...
Every output format reserves a slot for the thing the user did not want to hear, so honesty is structural rather than discretionary: _What To Cut_, _The Cost_, _If Defeat Is Certain_, _What Not To Do Yet_, _The Warrior's Assessment_, _What I Might Have Wrong_, _Where People Fall Off_, _What I Cannot Know_, _What Is Not Known_, _Where This Falls Apart_, _Quill Down_, _Intelligence Gaps_, _Convergence_, _If You Have Less Time_.
